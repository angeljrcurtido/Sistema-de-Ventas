...
const FacturasComponente = () => {
    ...
    const obtenerFacturas = async () => {
        try {
            const response = await axios.get('http://localhost:8000/todosticketnormal');
            setFacturas("Facturas:",response.data.tickets);
        } catch (error) {
            console.error(error);
        }
    };
    ...
    const anularTicket = async (id) => {
        try {
            await axios.put(`http://localhost:8000/ticketnormal/${id}/estado`, {
                estado: 'Anulado',
            });
    ...
    const obtenerFacturaParaImprimir = async (id) => {
        try {
            const response = await axios.get(`http://localhost:8000/ticketnormal/${id}`);
