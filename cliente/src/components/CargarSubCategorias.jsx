...
const CargarSubcategorias = () => {
  ...
  const obtenerCategorias = async () => {
    try {
      const response = await axios.get('https://node-mongo-api4.onrender.com/categories');
  ...
  const agregarSubcategoria = async () => {
    ...
    try {
      await axios.patch(`https://node-mongo-api4.onrender.com/categories/${categoriaSeleccionada}`, {
