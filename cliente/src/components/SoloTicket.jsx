    ...
    axios
      ...
      .then((res) => {
        ...
        const pdf = new jsPDF({
          ...
          unit: 'mm',
          format: [80, 100], // Tamaño de papel de 50x50 mm
        });
        ...
        pdf.autoTable({
          ...
          pageBreak: 'auto',
          headStyles: {
            fontSize: 10, // Tamaño de fuente para los rótulos de la tabla
          ...
          styles: {
            fontSize: 9, // Tamaño de fuente para el contenido de la tabla
